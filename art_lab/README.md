...
| `retratos/cida_seria/v1/`, `v2/` | A Dona Cida séria de cabeça REDONDA (frente 2): a v1, rejeitada pelo Bruno, e a v2 que a refaz — o script do Blender, o PNG, a prancha e a foto do jogo de cada uma | Claude Code, 23/09 |
...
| Dona Cida séria v2 (cabeça redonda) | estúdio Blender (`retratos/cida_seria/v2/`) | **à espera do Bruno**; foto do jogo tirada — muda só a caixa do retrato do boletim | O aceite dele; depois as outras duas expressões dela, e a pergunta da oficina, que ele deixou para depois da v2: o Sr. Ribeiro, o Arlindo e o trabalhador do rodapé continuam de caixas |
