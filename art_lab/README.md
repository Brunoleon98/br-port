...
| `retratos/cida_seria/v1/`, `v2/`, `quadrada_v1/`, `quadrada_v2/` | A Dona Cida séria (frente 2): a REDONDA v1, rejeitada, e a v2 que a refaz; a QUADRADA v1, no kit de caixas, que o Bruno escolheu contra a v2; e a quadrada v2, com os ajustes que ele pediu — o script do Blender, o PNG, a prancha e a foto do jogo de cada uma | Claude Code, 23–24/09 |
...
| Dona Cida séria quadrada v2 (kit de caixas) | estúdio Blender (`retratos/cida_seria/quadrada_v2/`) | **à espera do Bruno**; foto do jogo tirada — muda só a caixa do retrato do boletim | O aceite dele na foto do jogo; depois as outras duas expressões e o Sr. Ribeiro, o Arlindo e o trabalhador com as mesmas melhorias — a oficina não muda |
