...
| `retratos/cida_seria/v1/`, `v2/`, `quadrada_v1/` | A Dona Cida séria (frente 2): a REDONDA v1, rejeitada pelo Bruno, e a v2 que a refaz; e a QUADRADA melhorada, no kit de caixas, para ele escolher entre as duas — o script do Blender, o PNG, a prancha e a foto do jogo de cada uma | Claude Code, 23/09 |
...
| Dona Cida séria v2 (cabeça redonda) | estúdio Blender (`retratos/cida_seria/v2/`) | **à espera do Bruno**; foto do jogo tirada — muda só a caixa do retrato do boletim | Ele escolhe entre esta e a quadrada qual modelo melhorar; se for esta, a pergunta da oficina: o Sr. Ribeiro, o Arlindo e o trabalhador do rodapé continuam de caixas |
| Dona Cida séria quadrada v1 (kit de caixas) | estúdio Blender (`retratos/cida_seria/quadrada_v1/`) | **à espera do Bruno**, pedida por ele para comparar com a v2; foto do jogo tirada — muda só a caixa do retrato do boletim | Ele escolhe o modelo; se for esta, a oficina não muda, e o Sr. Ribeiro, o Arlindo e o trabalhador recebem as mesmas melhorias |
