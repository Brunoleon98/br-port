"""O Sr. Ribeiro no kit afinado — a candidata v3, nas três expressões.
...
`blender/brp_retratos.py` (`ribeiro`, `RIBEIRO`); o jogo só muda com o aceite.
    ...
    python3.11 art_lab/retratos/ribeiro/v3/gerar_candidato.py
...
CARAS = {
    ...
    # A v3: «grave mais triste» (o Bruno, na v2) — desapontado, olhar baixo e a
    # cabeça inclinada para o ombro, em vez do franzido zangado.
    ("ribeiro", "grave"): dict(boca="descontente", cenho="triste", olho="aberto",
                               olhar="baixo", pose=(-4.0, 7.0, -3.0)),
}
