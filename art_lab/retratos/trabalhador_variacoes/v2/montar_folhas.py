...
- `folha_ampliada.png` — a cabeça e os ombros de cada um, a 2x do cartão de
  1080 e sem suavizar, para ler o que a folha pequena não mostra.
    ...
    python3 art_lab/retratos/trabalhador_variacoes/v2/montar_folhas.py [png|previa]
"""
...
def main():
    ...
    # A cabeça e os ombros: o quarto de cima do quadro, sem o fundo vazio.
    _grade(pasta, 105, recorte=(150, 0, 618, 468), ampliar=2).save(AQUI / "folha_ampliada.png")
