...
|---|---|---|
| preço ou constante `# TUNING:` | **a skill `/balancear`** — ela conduz a medição e o rasto | 99,8% / 80,5% / 35,2% ainda de pé |
...
margem de ±18 pontos. Comparar aquele número com os 80,5% é comparar sorteio; o
