...
> **Esta skill é a F7** (`docs/decisoes/016`; a tabela das sete fases está no
> `CLAUDE.md`), e é **quase toda Sonnet** — é aí que a divisão poupa mais,
> porque o fecho é a cauda longa de toda sessão: as suítes, a captura, o
> `ESTADO_DO_PROJETO.md` em dia e o commit são receita escrita.
>
> ⚠️ **Menos a §5, a varredura do que se aprendeu, que é F6 disfarçada.**
> Decidir se uma lição vale SEMPRE — e por isso vai para o `CLAUDE.md` — ou se
> vale só ali é julgamento: essa sobe para **Opus**, e é a parte que este ritual
...
São as mesmas oito que o CI anexa a cada PR — a tela inicial, o porto a MEIO
