...
> calada.
>
> **Última atualização:** 23/09/2026 — a frente 2 do A5 volta ao Blender
>
...
| **A5** | Julgado (31 «Não»); **frente 1 feita**; a **2** (retratos) escolhida, e o protótipo vetorial REJEITADO — fica no Blender, e a próxima conversa pesquisa boas práticas antes de modelar. O material do ChatGPT vive em `art_lab/` (porta: o `README.md` de lá) | A ordem das frentes 3–6 é dele, e o galpão V3 que ele aprovou só existe lá (`art/f01-galpao`): **recuperar ou refazer**. O Codex entra por `AGENTS.md` |
