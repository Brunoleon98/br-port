...
| `brport_vs/tools/simular_balanceamento.gd` | Simulador — roda N partidas por perfil e mede a dificuldade. Imprime a **mistura de classes e de motivos** sorteada e exporta a que NÍVEL cada perfil chegou — é dele que o projetor tira quais navios cada porto recebe. **Quatro perfis**: Ótimo, Mediano, Descuidado e **Antecipado**, que quita a parcela antes do prazo (`018`) |
