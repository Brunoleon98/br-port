...
> calada.
>
> **Última atualização:** 23/09/2026 — a pesquisa de Blender da frente 2 do A5
>
...
| **A5** | Julgado (31 «Não»); **frente 1 feita**; a **2** (retratos) fica no Blender (o vetorial foi REJEITADO): a pesquisa está no §7 do plano de arte — o AgX que ninguém declarou, e o rosto redondo por script — e ele escolhe o que experimentar. O material do ChatGPT vive em `art_lab/` (porta: o `README.md` de lá) | A ordem das frentes 3–6 é dele, e o galpão V3 que ele aprovou só existe lá (`art/f01-galpao`): **recuperar ou refazer**. O Codex entra por `AGENTS.md` |
