...
lia-se como uma passadiça de madeira. Passou a ser um pau só com amantilho, e
ao construir o gooseneck que o prende apareceu o buraco: o **D17** prometia por
escrito que o pivô "caia dentro do DESENHO" da lança e media `used_rect`, que é
a moldura — e numa lança as linhas finas do amantilho e do cabo esticam a
moldura muito além da peça. Hoje ele mede quanto desenho há num raio de 2 px do
centro de rotação. `docs/decisoes/015`.
...
**E, para caber as caras sem foto (`060`),** desceu a mais antiga:
