...
const sections = [
  ...
  },
  {
    ...
    content: {
      ...
      fields: [
        { label: "Total herdado", value: "R$ 3.300.000 em 3 parcelas ao longo de 12 semanas" },
        { label: "Parcela 1 (sem. 4)", value: "R$ 550.000 — pequena, qualquer ritmo cobre. Tutorial de sobrevivência." },
        { label: "Parcela 2 (sem. 8)", value: "R$ 1.100.000 — exige contrato de frete ativo. Ponto dramático central." },
        { label: "Parcela 3 (sem. 12)", value: "R$ 1.650.000 — Sr. Abutre aparece antes como comprador. Ato simbólico." },
...
const DECISIONS = {
  ...
  economia: [
    ...
    { icon: "📋", title: "Valor de contratos",      summary: "R$ 8 mil → R$ 5 milhões",      detail: "Fase 1: R$ 8.000–70.000. Fase 2: R$ 25.000–200.000. Fase 3: R$ 60.000–500.000. Fase 4: R$ 150.000–1.500.000. Fase 5: R$ 500.000–5.000.000. Leilões: 1,5× teto da fase. Carga ilegal: 2× com risco de reputação." },
