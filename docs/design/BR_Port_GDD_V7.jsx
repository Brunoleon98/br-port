...
const DECISIONS = {
  ...
  economia: [
    ...
    { icon: "🏦", title: "Parcelas validadas",      summary: "R$ 8k / R$ 16k / R$ 24k",      detail: "VALIDADO por modelo de balanceamento (v1.0). Parcela 1 (sem. 4): R$ 8.000. Parcela 2 (sem. 8): R$ 16.000. Parcela 3 (sem. 12): R$ 24.000. Total: R$ 48.000. Cenário base (píer R$ 40/vaga + 2 barcos/sem) fecha com margem de ~R$ 300 no fim da semana 12 — viável, mas sem gordura. A Parcela 3 é o ponto de ruptura." },
    { icon: "📊", title: "Margem operacional base", summary: "~R$ 130/sem (Fase 1 sem armazém)", detail: "Receita semanal base: píer R$ 240 (6 vagas × R$ 40) + contratos R$ 360 (2 barcos × R$ 180) = R$ 600. Custos fixos: salários R$ 200 + manutenção R$ 30 = R$ 230. Margem: R$ 370/sem. Em 4 semanas = R$ 1.480 — insuficiente para cobrir a Parcela 3 de R$ 24.000 sozinho. O armazém (R$ 150–300/sem a partir da semana 2) é necessário para fechar o modelo." },
